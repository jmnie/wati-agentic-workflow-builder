...
![demo](docs/img/wati-demo.gif)

> 64-second silent walk-through, auto-generated by Playwright with on-screen
> captions. Covers plan preview, dry-run, confirmed execution, iteration with
> `for_each`, and context-aware clarification.
>
> Higher-quality MP4 (1.7 MB, H.264): [`docs/video/wati-demo.mp4`](docs/video/wati-demo.mp4).
